...
---
Django 쟝고 DRF 뷰셋 viewsets 라우터  view router r string models ORM serializer 해시 FBV CBV urlpattern include migration 폴더 둘러보기
...
파싱된 데이터를 다시 desirialize 하는 것. python 객체로 읽음. 그리고 저장
